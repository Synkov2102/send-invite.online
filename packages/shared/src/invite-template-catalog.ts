...
const crimsonEditorPreset: Partial<InviteState> = {
  bride: "Надя",
  groom: "Дима",
  date: "2027-07-17",
  time: "15:00",
  ...
  mapUrl:
    "https://yandex.ru/maps/?text=%D0%92%D0%B8%D0%BB%D0%BB%D0%B0%20%D0%90%D0%BD%D0%BD%D0%B0%20%D0%A1%D0%B0%D0%BD%D0%BA%D1%82-%D0%9F%D0%B5%D1%82%D0%B5%D1%80%D0%B1%D1%83%D1%80%D0%B3",
  ...
  dressCode:
    "Вы будете прекрасны в любых нарядах. Если захочется поддержать настроение дня, выбирайте бордовый, молочный, графитовый и чёрный.",
  ...
  groupChatText:
    "В чате гостей поделимся новостями дня, деталями трансфера и фотографиями после праздника.",
  showAdditionalInfo: true,
  additionalInfo:
    "Будем благодарны, если вместо цветов вы выберете бутылку любимого напитка или открытку с пожеланием. Главный подарок для нас — ваше присутствие.",
  rsvpText:
...
const chapterEditorPreset: Partial<InviteState> = {
  bride: "Настя",
  groom: "Андрей",
  date: "2026-05-23",
  time: "15:00",
  ...
  dressCode:
    "Будем рады, если ваши образы поддержат тёплую гамму праздника: терракота, песок и молочный.",
  ...
  groupChatText:
    "В общем чате гостей — тайминг дня, детали трансфера и фотографии после праздника.",
  showAdditionalInfo: true,
  additionalInfo:
    "Торжество проходит на территории отеля, часть программы — на улице. Позаботьтесь об удобной обуви и тёплой накидке на вечер.",
  rsvpText:
    "Пожалуйста, подтвердите присутствие. Ваш ответ поможет нам сохранить для вас место за общим столом.",
  rsvpDate: "2026-04-23",
...
const memoirEditorPreset: Partial<InviteState> = {
  bride: "Тая",
  groom: "Миша",
  date: "2027-07-23",
  time: "13:00",
  ...
  mapUrl:
    "https://yandex.ru/maps/?text=%D0%94%D0%9A%20%D0%A0%D0%B0%D1%81%D1%81%D0%B2%D0%B5%D1%82%20%D0%9C%D0%BE%D1%81%D0%BA%D0%B2%D0%B0",
  ...
  dressCode:
    "Выбирайте элегантные образы в глубоких синих, молочных, графитовых и приглушённых природных оттенках.",
  ...
  showAdditionalInfo: true,
  additionalInfo:
    "Будем рады вкладу в наше свадебное путешествие вместо цветов. И пожалуйста, захватите плёночную камеру, если она у вас есть.",
  rsvpText:
    "Пожалуйста, подтвердите присутствие. Ваш ответ поможет нам сохранить для вас место за общим столом.",
  rsvpDate: "2027-06-23",
...
const scribbleEditorPreset: Partial<InviteState> = {
  bride: "Катя",
  groom: "Вова",
  date: "2027-07-19",
  time: "15:30",
  city: "Тула",
  venue: "Усадьба «Двор Смайл»",
  address: "Сиреневая аллея, 7",
  lead: "Да-да, это мы! Время пронеслось незаметно, и у этих взрослых мальчика и девочки скоро свадьба. Будем счастливы разделить этот день с вами.",
  dressCode:
    "Поддержите настроение нашей свадьбы: выбирайте молочные, винные, графитовые и пудровые оттенки.",
  dressCodeColors: ["#f6efe3", "#8f001b", "#c9a2a7", "#3a3032", "#d8c6b3"],
  schedule: [
    {
      time: "15:30",
      title: "Сбор гостей",
      description: "Обнимаемся и знакомимся за бокалом игристого",
    },
    { time: "16:00", title: "Церемония", description: "Немного посмеёмся и немного поплачем" },
    { time: "17:00", title: "Праздничный ужин", description: "Тёплые слова, вкусная еда и танцы" },
    {
      time: "23:00",
      title: "Финал вечера",
      description: "Загадываем желание и сохраняем этот день в памяти",
    },
  ],
  showGroupChat: true,
  groupChatUrl: "https://t.me/+scribble-guests",
  groupChatText: "В чате гостей будут новости, детали трансфера и фотографии после праздника.",
  showAdditionalInfo: true,
  additionalInfo: "Церемония пройдёт на улице. Захватите удобную обувь и лёгкую накидку на вечер.",
  rsvpText:
    "Пожалуйста, подтвердите присутствие — так мы сможем всё подготовить и никого не потерять.",
  rsvpDate: "2027-06-19",
  paletteId: "crimson-paper",
};

const manorEditorPreset: Partial<InviteState> = {
  bride: "Ева",
  groom: "Даниил",
  date: "2026-08-26",
  time: "14:00",
  city: "Санкт-Петербург",
  venue: "Особняк Кушелева-Безбородко",
  address: "Свердловская наб., 40",
  mapUrl:
    "https://yandex.ru/maps/?text=%D0%9E%D1%81%D0%BE%D0%B1%D0%BD%D1%8F%D0%BA%20%D0%9A%D1%83%D1%88%D0%B5%D0%BB%D0%B5%D0%B2%D0%B0-%D0%91%D0%B5%D0%B7%D0%BE%D1%80%D0%BE%D0%B4%D0%BA%D0%BE",
  lead: "Мы рады сообщить, что назначили дату. Приглашаем вас разделить с нами день, когда наша история получит своё продолжение — в кругу тех, кто дорог нам больше всего.",
  dressCode:
    "Тема нашей свадьбы — old money: сдержанные силуэты, благородные ткани и спокойные оттенки. Белый цвет мы оставляем невесте — спасибо за понимание.",
  dressCodeColors: ["#e6dbd0", "#c9a89c", "#8a6a58", "#4a3d28"],
  schedule: [
    { time: "14:00", title: "Церемония", description: "Сбор гостей за 30 минут до начала" },
    { time: "16:00", title: "Фотосессия", description: "Общий кадр и портреты с гостями" },
    { time: "18:00", title: "Коктейль", description: "Игристое, канапе и живая музыка" },
    { time: "20:00", title: "Ужин", description: "Тёплые слова, тосты и танцы до ночи" },
  ],
  showGroupChat: true,
  groupChatUrl: "https://t.me/+manor-guests",
  groupChatText:
    "Закрытый чат для гостей: маршрут до особняка, где оставить машину и ответы на всё, что возникнет по дороге.",
  showAdditionalInfo: true,
  additionalInfo:
    "Часть церемонии пройдёт во внутреннем дворе — возьмите лёгкую накидку на вечер. Парковка у особняка ограничена, удобнее приехать такси. Если остаётесь в городе на ночь, напишите нам — подскажем отели рядом.",
  rsvpText:
    "Гостей мы рассадим за одним длинным столом, поэтому нам важно знать заранее, кого ждать. Несколько вопросов — и мы всё подготовим.",
  rsvpQuestions: [
    {
      title: "Ждать ли вас в особняке?",
      type: "single",
      options: ["Буду", "Будем вдвоём", "К сожалению, не смогу"],
    },
    {
      title: "Что подать вам за ужином?",
      type: "single",
      options: ["Мясо", "Рыбу", "Вегетарианское меню"],
    },
    {
      title: "Что налить для тоста?",
      type: "multiple",
      options: ["Шампанское", "Красное вино", "Белое вино", "Без алкоголя"],
    },
  ],
  rsvpDate: "2026-07-26",
  paletteId: "manor-ivory",
};
...
export const inviteTemplateCatalog: InviteTemplateDefinition[] = [
  ...
  },
  {
    ...
    name: "Бордо",
    description:
      "Бордовое приглашение с чёрно-белой фотосерией, крупной антиквой, журнальной сеткой и выразительными типографическими акцентами.",
    coverType: "arch",
    kind: "crimson",
    editorReady: true,
  ...
  },
  {
    ...
    name: "Фотоархив",
    description:
      "История от детского снимка до свадьбы: тёплая бумага, глубокий индиго, рукописные акценты и живая чёрно-белая хроника.",
    coverType: "arch",
    kind: "memoir",
    editorReady: true,
  ...
  },
  {
    ...
    name: "Глава",
    description:
      "Ретро-билет на тёплой бумаге: крупная узкая типографика, курсивные акценты, терракотовые плашки и вырубка по краям.",
    coverType: "arch",
    kind: "chapter",
    editorReady: true,
  ...
  },
  {
    ...
    name: "От руки",
    description:
      "Тёплая свадебная записка с бордовыми каракулями, живым календарём, полароидами и неровными бумажными акцентами.",
    coverType: "arch",
    kind: "scribble",
    editorReady: true,
    editorPreset: scribbleEditorPreset,
    defaultPaletteId: "crimson-paper",
    recommendedPaletteIds: [
      "crimson-paper",
      "scribble-cherry",
  ...
  },
  {
    ...
    name: "Особняк",
    description:
      "Приглашение в духе old money: полосатый кант, дидон-антиква со свэшами, лента-бант, обратный отсчёт и тёмный разворот с адресами.",
    coverType: "arch",
    kind: "manor",
    editorReady: true,
    editorPreset: manorEditorPreset,
    defaultPaletteId: "manor-ivory",
    recommendedPaletteIds: [
      "manor-ivory",
      "manor-graphite",
      "manor-navy",
