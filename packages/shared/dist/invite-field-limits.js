...
function isWithinLimit(value, max) {
    return value.length <= max;
}
function isStringArrayWithinLimit(value, maxItems, maxItemLength) {
...
function validateInviteFieldLimits(value) {
    ...
    const invite = value;
    const limits = exports.INVITE_FIELD_LIMITS;
    const stringChecks = [
