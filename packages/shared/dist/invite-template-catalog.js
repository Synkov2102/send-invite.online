...
const scribbleEditorPreset = {
    ...
    dressCode: "Поддержите настроение нашей свадьбы: выбирайте молочные, винные, графитовые и пудровые оттенки.",
    ...
    rsvpText: "Пожалуйста, подтвердите присутствие — так мы сможем всё подготовить и никого не потерять.",
    rsvpDate: "2027-06-19",
    paletteId: "crimson-paper",
};
const manorEditorPreset = {
    bride: "Ева",
    groom: "Даниил",
    date: "2026-08-26",
    time: "14:00",
    ...
    mapUrl: "https://yandex.ru/maps/?text=%D0%9E%D1%81%D0%BE%D0%B1%D0%BD%D1%8F%D0%BA%20%D0%9A%D1%83%D1%88%D0%B5%D0%BB%D0%B5%D0%B2%D0%B0-%D0%91%D0%B5%D0%B7%D0%BE%D1%80%D0%BE%D0%B4%D0%BA%D0%BE",
    ...
    dressCode: "Тема нашей свадьбы — old money: сдержанные силуэты, благородные ткани и спокойные оттенки. Белый цвет мы оставляем невесте — спасибо за понимание.",
    ...
    groupChatText: "Закрытый чат для гостей: маршрут до особняка, где оставить машину и ответы на всё, что возникнет по дороге.",
    showAdditionalInfo: true,
    additionalInfo: "Часть церемонии пройдёт во внутреннем дворе — возьмите лёгкую накидку на вечер. Парковка у особняка ограничена, удобнее приехать такси. Если остаётесь в городе на ночь, напишите нам — подскажем отели рядом.",
    rsvpText: "Гостей мы рассадим за одним длинным столом, поэтому нам важно знать заранее, кого ждать. Несколько вопросов — и мы всё подготовим.",
    rsvpQuestions: [
        {
...
const skazkaEditorPreset = {
    ...
    mapUrl: "https://yandex.ru/maps/?text=%D0%A2%D0%B5%D1%80%D0%B5%D0%BC%20%D0%91%D0%B5%D1%80%D0%B5%D0%BD%D0%B4%D0%B5%D0%B5%D0%B2%D0%BA%D0%B0",
    ...
    dressCode: "Наряжайтесь нарядно, да с душой: подойдут платья, костюмы или рубаха-косоворотка — главное, чтобы вы сияли и улыбались.",
    ...
    groupChatText: "Завели чат для гостей — там дорога до терема, программа праздника и фото да видео на память.",
    showAdditionalInfo: true,
    additionalInfo: "Гуляем всей семьёй — будут и малые дети, и почтенные гости. От всей души просим воздержаться от криков «горько» после полуночи, чтобы не будить малышню.",
    rsvpText: "Чтобы всё удалось на славу, отзовитесь да подтвердите, ждать ли вас. Ответьте на несколько вопросов ниже.",
    rsvpQuestions: [
        {
...
exports.inviteTemplateCatalog = [
    ...
    },
    {
        ...
        description: "Бордовое приглашение-билет с конвертом, рваными бумажными кромками, жемчужной нитью и кружевными деталями.",
        coverType: "arch",
        kind: "velvet",
        editorReady: true,
    ...
    },
    {
        id: "handwritten-note",
        name: "От руки",
        description: "Тёплая свадебная записка с бордовыми каракулями, живым календарём, полароидами и неровными бумажными акцентами.",
        coverType: "arch",
        kind: "scribble",
        editorReady: true,
    ...
    },
    {
        id: "manor-stripe",
        name: "Особняк",
        description: "Приглашение в духе old money: полосатый кант, дидон-антиква со свэшами, лента-бант, обратный отсчёт и тёмный разворот с адресами.",
        coverType: "arch",
        kind: "manor",
        editorReady: true,
    ...
    },
    {
        id: "skazka-lubok",
        name: "Сказ",
        description: "Русский народный стиль: хохломская роспись, старинная вязь в заголовках, берёзы и лубочные орнаменты на кремовой бумаге.",
        coverType: "arch",
        kind: "skazka",
        editorReady: true,
    ...
    },
    {
        id: "petal-party",
        name: "Лепестки",
        description: "Крупные цветы, рисованные детали и чёрно-белая фотоистория в десяти мягких цветовых сочетаниях.",
        coverType: "arch",
        kind: "petal",
        editorReady: true,
        ...
        editorPreset: {
            ...
            dressCode: "Будем рады, если вы поддержите настроение нашего праздника и выберете наряды в мягких оттенках нашей палитры. Самое главное — ваше хорошее настроение!",
            ...
            showAdditionalInfo: true,
            additionalInfo: "Ваше присутствие — самый ценный подарок. Если хочется порадовать нас ещё чем-то, будем рады бутылочке любимого вина вместо цветов. А ваши пожелания сохраним на долгую память!",
            rsvpDate: "2027-05-15",
            rsvpText: "Пожалуйста, подтвердите ваше присутствие и расскажите о предпочтениях. Это поможет нам сделать праздник уютным для каждого.",
    ...
    },
    {
        ...
        description: "Свадебный билет в большое путешествие: глубокий синий, перфорированная бумага, воздушные маршруты и чёрно-белые фотографии.",
        coverType: "arch",
        kind: "voyage",
        editorReady: true,
        ...
        editorPreset: {
            ...
            dressCode: "Будем рады, если вы поддержите настроение нашего дня нарядами в палитре праздника: молочный, песочный, глубокий синий и графитовый.",
            ...
            showAdditionalInfo: true,
            additionalInfo: "Главный подарок для нас — ваше присутствие. Вместо цветов будем рады открытке с пожеланием или советом для нашего первого семейного путешествия.",
            rsvpDate: "2027-05-21",
            rsvpText: "Подтвердите, пожалуйста, ваше присутствие. Так мы сможем позаботиться о каждом госте на борту нашего праздника.",
